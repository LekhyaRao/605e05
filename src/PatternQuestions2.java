 ...
 * - Processing multiple lines - can a regex match more than one line?
 * -
 *
 * More:
...
// Find a text to match the pattern
        ...
        // an example of using line termination in the pattern
        text = "b\nab";
        patternDefinition = "\\na";
...
//		// an example of using multi-line input for the pattern compiler
//		text = "b\nab";
//		patternDefinition = "^a";
//		Pattern stringPattern = Pattern.compile( patternDefinition,
//				Pattern.MULTILINE );
